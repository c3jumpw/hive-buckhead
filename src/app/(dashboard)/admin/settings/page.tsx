...
export default async function AdminSettingsPage() {
  ...
  return <AdminClient session={session} initialTab="settings" stats={{ staffCount: 0, tableCount: 0, barSeatCount: 0, rsvpCount: 0 }} recentReservations={[]} staff={staff} tables={[]} hours={[]} messageTemplates={[]} />
}
